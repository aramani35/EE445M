...
int main(void){
  ...
  statusHeap = Heap_Init();

  ptr = Heap_Malloc(sizeof(int16_t));
  *ptr = 0x1111;
  statusHeap = Heap_Test();

  statusHeap = Heap_Free(ptr);
  statusHeap = Heap_Test();
  ...
  statusHeap = Heap_Free(p1);
  statusHeap = Heap_Free(p3);
  statusHeap = Heap_Test();

  statusHeap = Heap_Free(p2);
  statusHeap = Heap_Test();
  stats = Heap_Stats();
